...
const TONES = [
  ...
  accentGlowStrong: "rgba(192,132,252,0.48)",
  orbColor1: "radial-gradient(circle, rgba(192,132,252,0.22) 0%, transparent 70%)",
  orbColor2: "radial-gradient(circle, rgba(192,132,252,0.1) 0%, transparent 70%)",
  cardBar: "linear-gradient(90deg, transparent, #C084FC, transparent)",
  statGlow: "0 0 40px rgba(192,132,252,0.35)",
  titleGlow: "0 0 60px rgba(192,132,252,0.4), 0 0 120px rgba(192,132,252,0.18)",
  scrollLine: "linear-gradient(to bottom, rgba(192,132,252,0.7), transparent)",
  hexColor: "#C084FC",
  quoteAccent: "#C084FC",
  ctaRadial: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(192,132,252,0.07) 0%, transparent 70%)",
  badgeBorder: "rgba(192,132,252,0.35)",
  badgeBg: "rgba(192,132,252,0.06)",
  badgeDot: "#C084FC",
},
{
  id: "spiritual",
  ...
  accentGlowStrong: "rgba(255,182,213,0.48)",
  orbColor1: "radial-gradient(circle, rgba(255,182,213,0.22) 0%, transparent 70%)",
  orbColor2: "radial-gradient(circle, rgba(255,182,213,0.1) 0%, transparent 70%)",
  cardBar: "linear-gradient(90deg, transparent, #FFB6D5, transparent)",
  statGlow: "0 0 40px rgba(255,182,213,0.35)",
  titleGlow: "0 0 60px rgba(255,182,213,0.4), 0 0 120px rgba(255,182,213,0.18)",
  scrollLine: "linear-gradient(to bottom, rgba(255,182,213,0.7), transparent)",
  hexColor: "#FFB6D5",
  quoteAccent: "#FFB6D5",
  ctaRadial: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(255,182,213,0.07) 0%, transparent 70%)",
  badgeBorder: "rgba(255,182,213,0.35)",
  badgeBg: "rgba(255,182,213,0.06)",
  badgeDot: "#FFB6D5",
},
{
  id: "empathetic",
  ...
  accentGlowStrong: "rgba(255,245,225,0.38)",
  ...
  cardBar: "linear-gradient(90deg, transparent, #FFF5E1, transparent)",
  statGlow: "0 0 40px rgba(255,245,225,0.28)",
  titleGlow: "0 0 60px rgba(255,245,225,0.35), 0 0 120px rgba(255,245,225,0.14)",
  scrollLine: "linear-gradient(to bottom, rgba(255,245,225,0.6), transparent)",
  hexColor: "#FFF5E1",
  quoteAccent: "#FFF5E1",
  ctaRadial: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(255,245,225,0.06) 0%, transparent 70%)",
  badgeBorder: "rgba(255,245,225,0.28)",
  badgeBg: "rgba(255,245,225,0.05)",
  badgeDot: "#FFF5E1",
},
];
